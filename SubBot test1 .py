...
url = eval(input("put in URL [ENTER = default for YouTube LukeProducts]:\n>> "))
if url == '':
...
sleeptime = 1
while True:
    sleeptime = eval(input("enter sleeptime [ENTER = default = 0,01 sec.]:\n>> "))
    if sleeptime == '':
        sleeptime = 0.01
...
while True:
    exittime = eval(input("how many tries? [ENTER = default = 1000 tries] :\n>> "))
    if exittime == '':
        exittime = 1000
